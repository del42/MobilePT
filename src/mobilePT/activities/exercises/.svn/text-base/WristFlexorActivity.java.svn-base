...
public class WristFlexorActivity extends Activity implements SensorEventListener {
	 ...
	 * 
	 * if this activity class was made to be an interface, this would be one
	 * of the methods that will be required to be implemented, because implementation of
	 * this method varies across all exercises 
	 * 
	...
	private void processFeedback(ArrayList<ArrayList<String>> aClassified) {
		...
		for (int index = 0; index < aClassified.size(); index++) {
			...
			if (classification == "WristFlexorPalmUpTooFast") {
